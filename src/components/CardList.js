...
const CardList = (props) => {
  ...
  const  [cardAllignment , setCardAllignment] = useState(createCardAllignment(cards.length * 2))



  useEffect( () => setCardElements(createCardElements(cards , cardAllignment)) , [cards , selectedCards])
